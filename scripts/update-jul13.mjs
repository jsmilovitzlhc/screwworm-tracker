...
// Per APHIS July 13 update: 2 cases changed from active → inactive
// IDs 14 (Jun 21, Edwards, Cattle), 15 (Jun 21, Edwards, Cattle)
const statusUpdates = [14, 15];
...
try {
  ...
  await sql`
    INSERT INTO screwworm_metadata (key, value) VALUES ('lastUpdated', ${JSON.stringify('2026-07-13T00:00:00Z')})
    ON CONFLICT (key) DO UPDATE SET value = EXCLUDED.value
  `;
  await sql`
    INSERT INTO screwworm_metadata (key, value) VALUES ('lastChecked', ${JSON.stringify('2026-07-14T05:30:00Z')})
    ON CONFLICT (key) DO UPDATE SET value = EXCLUDED.value
  `;
  console.log('Updated metadata timestamps to lastUpdated=2026-07-13, lastChecked=2026-07-14');
