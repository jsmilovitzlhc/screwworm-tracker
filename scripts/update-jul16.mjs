...
// Per APHIS July 16 update:
// 5 cases changed active → inactive: IDs 16,17,18,19 (Terrell Co.) and 20 (Medina Co.)
// 4 new cases added: IDs 36-39
const statusUpdates = [16, 17, 18, 19, 20];
...
const newCases = [
  {
    ...
    lng: -103.23,
    status: 'active',
    notes: 'Second Brewster County case; SU:21744:26',
  },
  {
    id: 37,
    date: '2026-07-13',
    ...
    lng: -100.5307,
    status: 'active',
    notes: 'First canine case in Sutton County; third dog case in outbreak; SU:21758:26',
  },
  {
    id: 38,
    date: '2026-07-14',
    ...
    lng: -103.4832,
    status: 'active',
    notes: 'First ovine case in Pecos County; SU:21829:26',
  },
  {
    id: 39,
    date: '2026-07-14',
    ...
    lng: -103.5032,
    status: 'active',
    notes: 'Second ovine case in Pecos County; same-day cluster; SU:21830:26',
  },
];
...
try {
  ...
  await sql`
    INSERT INTO screwworm_metadata (key, value) VALUES ('lastUpdated', ${JSON.stringify('2026-07-16T00:00:00Z')})
    ON CONFLICT (key) DO UPDATE SET value = EXCLUDED.value
  `;
  await sql`
    INSERT INTO screwworm_metadata (key, value) VALUES ('lastChecked', ${JSON.stringify('2026-07-16T09:30:00Z')})
    ON CONFLICT (key) DO UPDATE SET value = EXCLUDED.value
  `;
  console.log('Updated metadata timestamps to lastUpdated=2026-07-16');
